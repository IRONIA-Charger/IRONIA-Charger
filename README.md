# Olá, eu sou Enzo Lacerda

### Sobre mim
-Estudante de Engenharia de Software
-Foco em CyberSecurity
-Traçando rota para ser do Purple Team
-Entusiasta de Linux
...
Mas decidi ser um pouco mais ambicioso e escolher o caminho do Purple Team. Não conseguia decidir entre o ataque e a defesa, então pensei: se você pode aprender os dois lados para ser um profissional mais completo, por que escolher um só? Hoje, meu objetivo é entender como as falhas acontecem para saber exatamente como protegê-las. É um degrau de cada vez, mas a direção eu já sei qual é.
